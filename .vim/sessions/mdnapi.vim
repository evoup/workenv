...
silent only
cd ~/project/mdn_receiver/mdnapi_alpha
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 index.m
badd +40 services/Sgeneral.m
badd +22 test/request.php
badd +19 ~/project/mmsapi/maas_debug/fun/mdndeliver_settingFun.m
badd +43 lib/thrift/packages/Hbase/Hbase.php
badd +24 fun/fun.mdb.m
badd +23 thrift/packages/Hbase/Hbase.php
badd +61 inc/const.m
silent! argdel *
edit index.m
...
let s:l = 39 - ((38 * winheight(0) + 15) / 30)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
39
normal! 0
lcd ~/project/mdn_receiver/mdnapi_alpha
tabedit ~/project/mdn_receiver/mdnapi_alpha/services/Sgeneral.m
set splitbelow splitright
set nosplitright
wincmd t
set winheight=1 winwidth=1
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 39 - ((13 * winheight(0) + 14) / 29)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
39
normal! 070l
lcd ~/project/mdn_receiver/mdnapi_alpha
tabedit ~/project/mdn_receiver/mdnapi_alpha/test/request.php
set splitbelow splitright
set nosplitright
wincmd t
set winheight=1 winwidth=1
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 23 - ((15 * winheight(0) + 14) / 29)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
23
