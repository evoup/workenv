...
set shortmess=aoO
badd +0 modules/scan_serving.php
badd +85 modules/scan_madn.php
badd +66 modules/cls_madn.php
badd +0 modules/mail.php
silent! argdel *
edit modules/scan_serving.php
...
146
normal zo
let s:l = 149 - ((84 * winheight(0) + 28) / 57)
...
tabedit ~/project/management/monitor_server/modules/scan_madn.php
set splitbelow splitright
set nosplitright
wincmd t
set winheight=1 winwidth=1
...
normal! 0
lcd ~/project/management/monitor_server
tabedit ~/project/management/monitor_server/modules/mail.php
set splitbelow splitright
set nosplitright
wincmd t
set winheight=1 winwidth=1
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 214 - ((38 * winheight(0) + 28) / 56)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
214
