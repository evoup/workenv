...
silent only
cd ~/project/management/madmonitor2/madmonitorErlang/erlang/apps/madmonitor2/src
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 madmonitor2.erl
badd +1 monitor_init.erl
badd +1 ~/project/management/madmonitor2/madmonitorErlang/erlang/apps/madmonitor2/files/netstat/freebsd/9.0/amd64/main.c
badd +19 ~/project/management/madmonitor2/madmonitorErlang/erlang/apps/madmonitor2/files/getload.c
badd +1 mm_util.erl
badd +0 ~/project/management/madmonitor2/madmonitorErlang/erlang/apps/madmonitor2/src
silent! argdel *
edit madmonitor2.erl
...
54
normal! 0
lcd ~/project/management/madmonitor2/madmonitorErlang/erlang/apps/madmonitor2/src
tabedit ~/project/management/madmonitor2/madmonitorErlang/erlang/apps/madmonitor2/src/monitor_init.erl
set splitbelow splitright
set nosplitright
wincmd t
set winheight=1 winwidth=1
...
normal! 053l
lcd ~/project/management/madmonitor2/madmonitorErlang/erlang/apps/madmonitor2/src
tabedit ~/project/management/madmonitor2/madmonitorErlang/erlang/apps/madmonitor2/src/mm_util.erl
set splitbelow splitright
set nosplitright
wincmd t
set winheight=1 winwidth=1
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 64 - ((48 * winheight(0) + 28) / 56)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
64
...
argglobal
enew
file ~/project/management/madmonitor2/madmonitorErlang/erlang/apps/madmonitor2/src
let s:cpo_save=&cpo
set cpo&vim
...
setlocal wrapmargin=0
lcd ~/project/management/madmonitor2/madmonitorErlang/erlang/apps/madmonitor2/src
tabedit ~/project/management/madmonitor2/madmonitorErlang/erlang/apps/madmonitor2/files/netstat/freebsd/9.0/amd64/main.c
set splitbelow splitright
set nosplitright
wincmd t
set winheight=1 winwidth=1
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 358 - ((9 * winheight(0) + 28) / 56)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
358
