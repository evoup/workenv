...
set shortmess=aoO
badd +1 index.m
badd +1 services/Sgeneral.m
badd +1 modules/preDispatch.m
badd +1 ~/project/mdn_receiver/mdnapi_alpha
badd +0 test/request.php
badd +0 inc/mime.m
silent! argdel *
edit index.m
...
let s:l = 51 - ((16 * winheight(0) + 16) / 33)
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 62 - ((19 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
62
normal! 026l
lcd ~/project/mdn_receiver/mdnapi_alpha
tabedit ~/project/mdn_receiver/mdnapi_alpha/modules/preDispatch.m
set splitbelow splitright
set nosplitright
wincmd t
set winheight=1 winwidth=1
...
normal! 0
lcd ~/project/mdn_receiver/mdnapi_alpha
tabedit ~/project/mdn_receiver/mdnapi_alpha/inc/mime.m
set splitbelow splitright
set nosplitright
wincmd t
set winheight=1 winwidth=1
