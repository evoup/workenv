...
silent only
cd ~/project/management/madmonitor2/erlang
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 src/madmonitor.erl
badd +13 src/mm_app.erl
badd +11 src/mm_sup.erl
badd +65 src/fun_common.erl
badd +1 src/include/inc.hrl
badd +6 priv/l4e.conf
badd +1 priv/log4erl.conf
badd +5 src/monitor_init.erl
badd +10 testl4erl.erl
badd +1 ~/project/management/madmonitor2/erlang
silent! argdel *
edit src/madmonitor.erl
...
let s:l = 29 - ((10 * winheight(0) + 16) / 32)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
29
normal! 06l
lcd ~/project/management/madmonitor2/erlang
tabedit ~/project/management/madmonitor2/erlang/src/fun_common.erl
set splitbelow splitright
set nosplitright
wincmd t
set winheight=1 winwidth=1
...
normal! 0
lcd ~/project/management/madmonitor2/erlang
tabedit ~/project/management/madmonitor2/erlang/src/include/inc.hrl
set splitbelow splitright
set nosplitright
wincmd t
set winheight=1 winwidth=1
...
normal! 032l
lcd ~/project/management/madmonitor2/erlang
tabedit ~/project/management/madmonitor2/erlang/src/mm_sup.erl
set splitbelow splitright
set nosplitright
wincmd t
set winheight=1 winwidth=1
...
normal! 0
lcd ~/project/management/madmonitor2/erlang
tabedit ~/project/management/madmonitor2/erlang/src/monitor_init.erl
set splitbelow splitright
set nosplitright
wincmd t
set winheight=1 winwidth=1
