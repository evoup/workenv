...
silent only
cd ~/project/indiaMadhouseIp
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 procedureIp.m
badd +12 modules/indiaIpGo25.m
badd +39 modules/makeIspTable.m
badd +16771 modules/geoip/isp.csv
badd +17 inc/const.m
badd +51 inc/inc.m
badd +1 /services/indiaMadhouseip_deal/work/t_madhouse_serv_india.csv
badd +1 modules/importIndiaIp.m
badd +15 modules/importIspTable.m
badd +64 modules/init.m
badd +39 test2.csv
badd +1 modules/geoip/geoipregionvars.php
silent! argdel *
edit procedureIp.m
...
let s:l = 36 - ((20 * winheight(0) + 22) / 44)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
36
normal! 030l
lcd ~/project/indiaMadhouseIp
tabedit ~/project/indiaMadhouseIp/modules/indiaIpGo25.m
set splitbelow splitright
set nosplitright
wincmd t
set winheight=1 winwidth=1
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 68 - ((7 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
68
normal! 072l
lcd ~/project/indiaMadhouseIp
tabedit ~/project/indiaMadhouseIp/modules/importIndiaIp.m
set splitbelow splitright
set nosplitright
wincmd t
set winheight=1 winwidth=1
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 23 - ((15 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
23
normal! 03l
lcd ~/project/indiaMadhouseIp
tabedit ~/project/indiaMadhouseIp/inc/const.m
set splitbelow splitright
set nosplitright
wincmd t
set winheight=1 winwidth=1
...
normal! 010l
lcd ~/project/indiaMadhouseIp
tabedit ~/project/indiaMadhouseIp/modules/geoip/geoipregionvars.php
set splitbelow splitright
set nosplitright
wincmd t
set winheight=1 winwidth=1
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 1719 - ((30 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1719
normal! 011l
lcd ~/project/indiaMadhouseIp
tabedit ~/project/indiaMadhouseIp/inc/inc.m
set splitbelow splitright
set nosplitright
wincmd t
set winheight=1 winwidth=1
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 49 - ((18 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
49
