...
silent only
cd ~/project/mmsapi/maas_debug
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 index.m
badd +139 fun/mdndeliver_settingFun.m
badd +183 inc/const.m
badd +1 thrift/packages/Hbase/Hbase.php
silent! argdel *
edit index.m
...
7
normal! 0
lcd ~/project/mmsapi/maas_debug
tabedit ~/project/mmsapi/maas_debug/fun/mdndeliver_settingFun.m
set splitbelow splitright
set nosplitright
wincmd t
set winheight=1 winwidth=1
...
185
normal zo
let s:l = 141 - ((22 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
141
normal! 019l
lcd ~/project/mmsapi/maas_debug
tabedit ~/project/mmsapi/maas_debug/thrift/packages/Hbase/Hbase.php
set splitbelow splitright
set nosplitright
wincmd t
set winheight=1 winwidth=1
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 35 - ((27 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
35
normal! 0
lcd ~/project/mmsapi/maas_debug
tabedit ~/project/mmsapi/maas_debug/inc/const.m
set splitbelow splitright
set nosplitright
wincmd t
set winheight=1 winwidth=1
...
165
normal zo
let s:l = 182 - ((18 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
182
