...
silent only
cd ~/project/madhouse_ip
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +48 procedureIp.m
badd +1 modules/czipMadhouseServGoHbase.m
badd +292 fun/fun.common.m
badd +1 /services/madhouseip_deal/work/iprange.csv
badd +21 modules/makeWorkTableRange.m
badd +43 modules/czipGoHbase.m
badd +14 1
badd +81 modules/makeRangeCsv.m
badd +5269 /services/serving_log/ip_update.log
badd +55 inc/inc.m
badd +1 test/testLastCsv.m
badd +3 /services/madhouseip_deal/work/lastCsv.csv
badd +100 modules/makeWorkTable.m
badd +1 /services/madhouseip_deal/work/qqwry.txt
badd +17 test/w.php
badd +1 README
badd +114 modules/makeCityData.m
silent! argdel *
edit procedureIp.m
...
setlocal nodiff
setlocal equalprg=
setlocal errorformat=%E<b>Parse\ error</b>:\ %m\ in\ <b>%f</b>\ on\ line\ <b>%l</b><br\ />,%W<b>Notice</b>:\ %m\ in\ <b>%f</b>\ on\ line\ <b>%l</b><br\ />,%EParse\ error:\ %m\ in\ %f\ on\ line\ %l,%WNotice:\ %m\ in\ %f</b>\ on\ line\ %l,%-G%.%#
setlocal expandtab
if &filetype != 'php'
...
54
normal! 0
lcd ~/project/madhouse_ip
tabedit ~/project/madhouse_ip/README
set splitbelow splitright
set nosplitright
wincmd t
set winheight=1 winwidth=1
...
normal! 0130l
lcd ~/project/madhouse_ip
tabedit ~/project/madhouse_ip/modules/czipMadhouseServGoHbase.m
set splitbelow splitright
set nosplitright
wincmd t
set winheight=1 winwidth=1
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 60 - ((18 * winheight(0) + 10) / 21)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
60
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 18 - ((7 * winheight(0) + 10) / 21)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
18
normal! 0
lcd ~/project/madhouse_ip
tabedit ~/project/madhouse_ip/fun/fun.common.m
set splitbelow splitright
set nosplitright
wincmd t
set winheight=1 winwidth=1
...
299
normal zo
let s:l = 282 - ((16 * winheight(0) + 25) / 51)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
282
normal! 033l
lcd ~/project/madhouse_ip
tabedit /services/madhouseip_deal/work/qqwry.txt
set splitbelow splitright
set nosplitright
wincmd t
set winheight=1 winwidth=1
