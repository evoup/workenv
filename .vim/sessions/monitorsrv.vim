...
silent only
cd ~/project/management/monitor_server
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 index.php
badd +51 modules/mon_init.php
badd +18 modules/scan.php
badd +291 fun/fun.common.php
badd +116 fun/fun.engine.php
badd +48 /services/monitor_server/conf/monitor_server.ini
badd +19 fun/fun.host.php
silent! argdel *
edit index.php
...
let s:l = 29 - ((20 * winheight(0) + 14) / 29)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
29
normal! 0
lcd ~/project/management/monitor_server
tabedit ~/project/management/monitor_server/modules/mon_init.php
set splitbelow splitright
set nosplitright
wincmd t
set winheight=1 winwidth=1
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 302 - ((197 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
302
normal! 0
lcd ~/project/management/monitor_server
tabedit ~/project/management/monitor_server/fun/fun.common.php
set splitbelow splitright
set nosplitright
wincmd t
set winheight=1 winwidth=1
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 275 - ((6 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
275
normal! 0
lcd ~/project/management/monitor_server
tabedit ~/project/management/monitor_server/modules/scan.php
set splitbelow splitright
set nosplitright
wincmd t
set winheight=1 winwidth=1
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 18 - ((7 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
18
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 301 - ((15 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
301
normal! 028l
lcd ~/project/management/monitor_server
tabedit ~/project/management/monitor_server/fun/fun.engine.php
set splitbelow splitright
set nosplitright
wincmd t
set winheight=1 winwidth=1
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 89 - ((8 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
89
