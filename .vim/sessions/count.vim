...
badd +35 last2.csv
badd +17 last.csv
badd +1211 clo1518.log
badd +282 vcli1518.log
badd +1 count_nomysql.php
badd +1 count2.php
badd +1 x
badd +744 x.csv
badd +1 test.php
silent! argdel *
edit count_nomysql.php
...
normal! 0
lcd ~/vclick
tabedit ~/vclick/count_nomysql.php
set splitbelow splitright
set nosplitright
wincmd t
set winheight=1 winwidth=1
...
53
normal zo
let s:l = 135 - ((24 * winheight(0) + 27) / 54)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
135
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 59 - ((28 * winheight(0) + 27) / 54)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
59
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 308 - ((7 * winheight(0) + 27) / 54)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
308
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 209 - ((13 * winheight(0) + 27) / 54)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
209
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 1885 - ((26 * winheight(0) + 27) / 54)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1885
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 2107 - ((26 * winheight(0) + 27) / 54)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
2107
